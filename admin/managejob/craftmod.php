...
<div id="bigmiddle">
            ...
            <tr >
				...
				<?php if(($value['creator'] == $creator)||($adminid == 1)) echo '编辑';?>
				</a><?php if(($value['creator'] == $creator)||($adminid == 1)){ echo ' | ';}else{echo '无权限修改';}?>
				<a target="subframe" href="craftdel.php?id=<?php echo $value['id']?>" onclick= "return confirm('确定删除？');" ><?php if(($value['creator'] == $creator)||($adminid == 1)) echo '删除';?></a>
				</td>
			</tr>
                <?php
                    }
