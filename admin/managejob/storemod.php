...
<div id="bigmiddle">
            ...
            <tr >
				...
				<td bgcolor="#a1a3a6">
				<a target="subframe" href="storemod.edit.php?id=<?php echo $value['id']?>" >编辑</a> | 
				<a target="subframe" href="storedel.php?id=<?php echo $value['id']?>&sum=<?php echo $value['allsum']?>" onclick= "return confirm('库存为零才能删除库房！确定删除？');" >删除</a>
				</td>
			</tr>
                <?php
                    }
