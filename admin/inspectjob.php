	...
	<div id="CanvasDiv">
		<div id="HeaderDiv">
			<div id="AppInfoDiv">
				...
				<div id="AppInfoModuleDiv">工作查询</div>
			</div>
			<div id="QuickMenuDiv">
				<ul>
		...
		<div id="BodyDiv">
			<div id="MainMenuDiv">
				<ul>
					<li><a href="inspectjob/jobinspe.php" target="subframe">查询任务</a></li>
					<li><a href="inspectjob/craftinspe.php" target="subframe">查询工艺</a></li>
					<li><a href="inspectjob/meterialinspe.php" target="subframe">查询物料</a></li>
					<li><a href="inspectjob/storeinspe.php" target="subframe">查询仓库</a></li>
					<li><a href="inspectjob/contractinspe.php" target="subframe">查询合同</a></li>
				</ul>
			</div>
			<div id="SubMenuDiv">
