	...
	<div id="CanvasDiv">
		<div id="HeaderDiv">
			<div id="AppInfoDiv">
				...
				<div id="AppInfoModuleDiv">工作管理</div>
			</div>
			<div id="QuickMenuDiv">
				<ul>
		...
		<div id="BodyDiv">
			<div id="MainMenuDiv">
				<ul>
					<li><a href="managejob/jobmod.php" target="subframe">管理任务</a></li>
					<li><a href="managejob/craftmod.php" target="subframe">管理工艺</a></li>
					<li><a href="managejob/meterialmod.php" target="subframe">管理物料</a></li>
					<li><a href="managejob/storemod.php" target="subframe">管理库房</a></li>
				</ul>
			</div>
			<div id="SubMenuDiv">
